...
def get_args():
    ...
    parser.add_argument("--report", default="price_changes.csv")
...
def main():
    ...
    products = parse_category_pages(args.category, category_link)
    ...
    changes = check_price_changes(args.db, products)

    if changes:
        save_changes_csv(args.report, changes)
